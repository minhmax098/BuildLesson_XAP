...
namespace BuildLesson 
{
    public class LabelManager : MonoBehaviour
    {
        ...
        {    
            ...
            set
            {
                Debug.Log("LabelManager IsShowingLabel call"); 
        ...
        {  
            ...
            GameObject labelObject = Instantiate(Resources.Load(PathConfig.TAG_TOUCH) as GameObject);
        ...
        public IEnumerator SaveCoordinate(int lessonId, int modelId, string labelName, Vector3 coordinate, string level)
        {
            ...
            Debug.Log("Test data: " + requestBody);
            ...
            {   
                ...
                Debug.Log(webRequest.error); // Bad request 
            }
            else
            {
